...
export default function AdminBookings() {
  ...
  useEffect(() => {
    axios
      .get("/admin/getAllBookings") // adjust endpoint if needed
              ...
              return (
                ...
                >
                  ...
                  <div className="hidden md:grid grid-cols-[2fr_2fr_1.5fr_1fr_1fr_0.5fr] gap-4 px-6 py-4 items-center">
                    ...
                    {/* Status */}
                    <span
                      className={`inline-flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded-full w-fit ${S.cls} ${S.bg}`}
                    >
                    ...
                    <button
                      ...
                      className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-gray-100 text-gray-400 hover:text-blue-600 border-none cursor-pointer transition-colors"
                    >
                      <Eye size={15} />
                    </button>
                  </div>
                  ...
                  <div className="md:hidden px-5 py-4 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`text-xs font-semibold px-2.5 py-1 rounded-full ${S.cls} ${S.bg}`}
                      >
                        {S.label}
                      </span>
                    </div>
